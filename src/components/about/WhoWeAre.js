...
export default function WhoWeAre(){
    return (
        ...
        >
            ...
            <p>
                I think it's wild that companies spend thousands of dollars upfront, and even <em>more</em> every month thereafter. It's easier for a small business to make monthly payments so they can invest more in other operations. I wanted to create a business model that lets you participate at a reasonable subscription rate for a custom web presence.
            </p>
            <Link to="/contact">
